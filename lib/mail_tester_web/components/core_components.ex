defmodule MailTesterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MailTesterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MailTesterWeb.Gettext, "errors", msg, opts)
    end
  end
